export default function AboutPage() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-[#F5F0E8] text-[#1A1A1A]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Agent Name</h2>
            ...
            <div className="border-t border-[#E2D9C8] pt-6 flex flex-wrap gap-6">
              <div>
                ...
                <p className="font-semibold"># 00000000</p>
              </div>
              <div>
                <p className="text-xs tracking-widest uppercase text-[#8B7355] mb-1">
                  Brokerage
      ...
      {/* Stats */}
      <div className="bg-[#1A1A1A] text-[#F5F0E8] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat) => (
              <div key={stat.label}>
                ...
                <p className="text-xs tracking-widest uppercase text-[#F5F0E8]/50">
                  {stat.label}
                </p>
              </div>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold">My Core Values</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value) => (
            <div
              key={value.title}
              className="border border-[#E2D9C8] p-8 hover:border-[#C9A96E] transition"
            >
